...
def restart_department_classifier_space():
    try:
        ...
        return {"status": "success", "message": f"Restarted department classifier: {DEPARTMENT_RETRAIN_SPACE_ID}"}
...
def restart_urgency_classifier_space():
    try:
        ...
        return {"status": "success", "message": f"Restarted urgency classifier: {URGENCY_RETRAIN_SPACE_ID}"}
    except Exception as e:
        return {"status": "error", "message": str(e)}
...
def restart_prepare_dataset_space():
    try:
        ...
        return {"status": "success", "message": f"Restarted dataset preparation space: {PREPARE_DATASET_SPACE_ID}"}
    except Exception as e:
        return {"status": "error", "message": str(e)}
