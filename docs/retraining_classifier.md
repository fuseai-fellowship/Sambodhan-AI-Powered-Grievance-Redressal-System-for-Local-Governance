...
- [Architecture Components](#architecture-components)
    - [1. Seperate Inference Space (Production)](#1-seperate-inference-space-production)
        - [Purpose](#1-seperate-inference-space-production)
        - [Model](#1-seperate-inference-space-production)
        - [Endpoints](#1-seperate-inference-space-production)
        - [State](#1-seperate-inference-space-production)
    - [2. Retrain Space (Training)](#2-retrain-space-training)
        - [Purpose](#2-retrain-space-training)
        - [Trigger](#2-retrain-space-training)
        - [Runtime](#2-retrain-space-training)
        - [State](#2-retrain-space-training)
        - [Output](#2-retrain-space-training)
    - [3. Dataset Hub](#3-dataset-hub)
        - [Purpose](#3-dataset-hub)
        - [Format](#3-dataset-hub)
        - [Updates](#3-dataset-hub)
        - [Metadata](#3-dataset-hub)
    - [4. Model Hub](#4-model-hub)
        - [Purpose](#4-model-hub)
        - [Versions](#4-model-hub)
        - [Artifacts](#4-model-hub)
        - [Deployment](#4-model-hub)
    - [5. Weights & Biases](#5-weights--biases)
        - [Purpose](#5-weights--biases)
        - [Logged Data](#5-weights--biases)
        - [Projects](#5-weights--biases)

- [Retraining Pipeline Workflow](#retraining-pipeline-workflow)
    - [Complete End-to-End Process](#complete-end-to-end-process)
        ...
        - [4. FETCH DATASET](#4-fetch-dataset)
        - [5. INITIALIZE CLASSIFIER](#5-initialize-classifier)
        - [6. TRAIN MODEL](#6-train-model)
        - [7. EVALUATE PERFORMANCE](#7-evaluate-performance)
        - [8. LOG METRICS](#8-log-metrics)
        - [9. DECISION GATE](#9-decision-gate)
        - [10. DEPLOY MODEL (if accepted)](#10-deploy-model-if-accepted)
...
- [Technology Stack](#technology-stack)
    ...
    - [Model Training](#model-training)
        - [FocalLossTrainer](#focallosstrainer-custom-trainer)
        - [Training Arguments](#training-arguments)

- [Hugging Face Integration Strategy](#hugging-face-integration-strategy)
...
- [Deployment Architecture](#deployment-architecture)
    - [HF Spaces Structure](#hf-spaces-structure)
...
- [Quick Start Guide](#quick-start-guide)
    ...
    - [Step 1: Prepare Dataset](#step-1-prepare-dataset)
        - [Automated](#automated)
        - [Manual](#manual)
    - [Step 2: Create Inference Space](#step-2-create-inference-space)
    - [Step 3: Create Retrain Space](#step-3-create-retrain-space)
    ...
    - [Step 4: Trigger First Training](#step-4-trigger-first-training)
...
- [Troubleshooting](#troubleshooting)
    - [Common Issues](#common-issues)
        - [1. Training Fails to Start](#1-training-fails-to-start)
        - [2. Model Not Deploying](#2-model-not-deploying)
        - [3. WandB Login Fails](#3-wandb-login-fails)
        - [4. Space Won't Pause](#4-space-wont-pause)

- [Future Enhancements](#future-enhancements)
    - [Phase 1: Current Implementation](#phase-1-current-implementation)
    - [Phase 2: Next 3 Months](#phase-2-next-3-months)
    - [Phase 3: 6-12 Months](#phase-3-6-12-months)
    - [Phase 4: Long-term](#phase-4-long-term)
...
#### **11. SHUTDOWN**
- WandB Send Email with run Summary to Notify the Admin
- Finish WandB run
